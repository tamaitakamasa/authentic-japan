...
const SSGFORM_URL = {
  ja: "https://ssgform.com/s/Dwe48gfBEyBU",
  en: "https://ssgform.com/s/ZGSjc0jTDG6c",
  fr: "https://ssgform.com/s/Ujc38lPPzZCl",
};
...
export default function ContactForm({ lang }: { lang: Locale }) {
  ...
  async function onSubmit(data: ContactFormData) {
    try {
      ...
      formData.append(
        t({ ja: "お名前", en: "Name", fr: "Nom" }),
        data.name,
      );
      formData.append(
        t({ ja: "メールアドレス", en: "Email", fr: "E-mail" }),
        data.email,
      );
      formData.append(
        t({
      ...
      const response = await fetch(SSGFORM_URL[lang], {
        method: "POST",
        headers: {
