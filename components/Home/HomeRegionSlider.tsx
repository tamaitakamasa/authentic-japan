...
export function HomeRegionSlider({
  regions,
}: {
  lang: Locale;
  regions: Region[];
      ...
      <div className="p-home-regions-slider__navi">
        ...
        <div className="p-home-regions-slider__navi-items">
          {regions.map((region, index) => (
            <button
              key={region.id}
              className={`p-home-regions-slider__navi-item ${index === activeIndex ? "is-active" : ""}`}
            ...
            <SwiperSlide key={index}>
              <div className="p-home-regions-slider-slide">
                ...
                <div className="p-home-regions-slider-slide__bottom">
                  ...
                  <p
                    className="p-home-regions-slider-slide__description"
