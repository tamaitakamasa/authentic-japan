...
export function NavigatorCard({
  ...
  return (
    <Link
      ...
      className="c-navigator-card"
    >
      <figure className="c-navigator-card__image">
        <Image
          src={
            guide.mv?.sizes["1536x1536"] ??
            "/default-image.jpg"
          }
          alt=""
          fill
      ...
      <div className="c-navigator-card__inner">
        ...
        <div className="c-navigator-card__cols">
          <div className="c-navigator-card__col-left">
            <div className="c-navigator-card__photo">
              <Image
                src={
                  guide.photo?.link ?? "/default-image.jpg"
                }
                alt=""
                fill
                sizes="20vw"
          ...
          <div className="c-navigator-card__col-right">
            <h2 className="c-navigator-card__name">
              {guide.name}
            </h2>
            <h3 className="c-navigator-card__title">
              {guide.title}
            </h3>
          </div>
        </div>
        <div className="c-navigator-card__tags">
          {guide.tags.map((tag) => (
            <span
              key={tag.id}
              className="c-navigator-card__tag"
            >
              #{tag.name}
            </span>
          ))}
